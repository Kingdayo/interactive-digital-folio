    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="space-y-8 animate-fade-in-up">
          ...
          {/* Description */}
          <p className="text-xl text-foreground-muted max-w-2xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up" style={{ animationDelay: '1s' }}>
            <Button 
              size="lg" 
              className="morph-button bg-gradient-primary hover:scale-105 transition-transform duration-300 glow-primary text-lg px-8 py-6"
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="morph-button border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 text-lg px-8 py-6"
            >
              Download Resume
            </Button>
          </div>
          ...
          {/* Social Links */}
          <div className="flex justify-center space-x-6 animate-fade-in-up" style={{ animationDelay: '1.5s' }}>
            {[
              ...
              <Button
                ...
                variant="ghost"
                size="icon"
                className="morph-button hover-scale group hover:glow-primary transition-all duration-300"
