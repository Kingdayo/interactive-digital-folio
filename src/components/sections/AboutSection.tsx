...
const skills = [
  'React', 'TypeScript', 'Node.js', 'Python', 'GraphQL', 'MongoDB',
  'AWS', 'Docker', 'Kubernetes', 'Figma', 'Three.js', 'GSAP'
];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-foreground-muted">
                <p className="text-lg leading-relaxed">
                  ...
                  creating innovative digital solutions. My journey began with a fascination 
                  for how technology can transform ideas into reality.
                </p>
                <p className="text-lg leading-relaxed">
              ...
              <div className="flex flex-wrap gap-2">
                {skills.map((skill, index) => (
                  <Badge 
                    key={skill}
                    variant="secondary"
                    className={`morph-button hover-scale transition-all duration-300 ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {highlights.map((highlight, index) => (
              <Card 
                key={highlight.title}
                className={`glass-card p-6 hover:glow-primary transition-all duration-500 hover-scale group ${
                  isVisible ? 'animate-fade-in-up' : 'opacity-0'
                }`}
